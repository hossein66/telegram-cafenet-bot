...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        welcome_text = (
            f"به بات کافی‌نت آنلاین خوش آمدید {user.first_name}! 👋\n\n"
            "این بات به شما کمک می‌کند تا به راحتی خدمات اداری و دولتی را در اختیار داشته باشید، همچنین همه خدمات ضمانت بازگشت وجه را دارند.\n\n"
...
async def back_to_menu(query, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        user = query.from_user
        welcome_text = (
            f"به بات کافی نت خوش آمدید {user.first_name}! 👋\n"
    ...
    try:
        ...
        if is_dastadas or is_resalat or is_mehr:
            ...
            summary_lines = [
                ...
                f"🔹 **میزان سفته**: {fmt(loan_amount_rials + int(loan_amount_rials * 1.5))} تومان\n",
